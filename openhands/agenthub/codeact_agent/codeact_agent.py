...
class CodeActAgent(Agent):
    ...
    def __init__(self, config: AgentConfig, llm_registry: LLMRegistry) -> None:
        ...
        # Use router directly instead of explicit routing calls
        # This replaces the old initialize_router approach
    ...
    def step(self, state: State) -> 'Action':
        ...
        # Get messages for LLM completion (router will handle routing internally)
        messages = self._get_messages(condensed_history, initial_user_message)
        logger.debug(f'Using LLM: {self.llm.config.model}')
    ...
    def _get_messages(
        ...
        # Router will handle LLM selection internally
